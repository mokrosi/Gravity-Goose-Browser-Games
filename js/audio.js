const audio = {
    ...
    sounds: {
        ...
        nanoDead: new Audio("assets/audio/sounds/nano_death.wav"),
        bgTheme: new Audio("assets/audio/music/nano_theme.mp3"),
        ...
        banana : new Audio("assets/audio/sounds/banana.wav")
    },
    setVolume(vol) {
    ...
    init() {
        if (this.initialized) {
            this.sounds.bgTheme.currentTime = 0;
